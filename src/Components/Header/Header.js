...
const listenScrollEvent = (event) => {
  if (window.scrollY < 170) {
    return setHeader("js-main-nav-bar js-main-nav-bar--transparent main-nav-bar")
...
if (props.props===1){
  ...
  return (
    <nav className={header} >
       <Link to="/" > 
        <a className='main-nav-bar__logo' href='/ru-ru/' title='Бесплатные стоковые фото'>
         <div className='main-nav-bar__logo__img'>
            ...
            <div className='hide-when-mid-size-and-smaller main-nav-bar__logo__text' href='/ru-ru/'>Pexels</div>
           
        </a>
        </Link>
      <Search fun={props.fun}
         funct={props.funct} 
          value={props.value}/>
        <ul className='main-nav-bar__sub-nav'>
            <li className='hide-when-mid-size-and-smaller'>
                <div data-dropdown='explore'>
                    <a className='main-nav-bar__sub-nav__item' data-track-action='navbar' data-track-label='explore' href='/ru-ru/discover/'>{t("explore")}</a>
                </div>
            </li>
            <li className='hide-when-mid-size-and-smaller'>
                <a className='main-nav-bar__sub-nav__item' data-track-action='navbar' data-track-label='license' href='/ru-ru/license/'>{t("license")}</a>
            </li>
        
           
            <li className='hide-when-mid-size-and-smaller'>
                <a className='main-nav-bar__sub-nav__item' data-track-action='navbar' data-track-label='submit-photos' href='/ru-ru/join-contributor/'>{t("upload")}</a>
            </li>
            {/* <li className='#'>
    ...
    // </div>
        ...
        <li
          ...
          {/* <span>Русский</span> */}
            ...
            <li className='#'>
                <a className='main-nav-bar__sub-nav__item main-nav-bar__sub-nav__item--button' data-track-action='navbar' data-track-label='signup' href='/ru-ru/onboarding/'> {t("join")}</a>
            </li>

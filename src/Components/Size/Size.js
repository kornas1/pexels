...
const Orientation = (props) => {
  ...
  return (
    ...
    <ul className="choice__params__el__options">
      <li
        data-active={props.size === '' ? true : false}
       >
        <div
        //   onClick={() => 
        //     { setprops.Size(``);
      ...
      <li
        data-active={props.size === 'large' ? true : false}
       >
        <div
        //   onClick={() => 
        //     { setprops.Size(`large`);
      ...
      <li 
       data-active={props.size === 'medium' ? true : false}
      >
        <div
        //   onClick={() => 
      ...
      <li
        data-active={props.size === 'small' ? true : false}
       >
        <div
        //   onClick={() => 
        //     { setprops.Size(`small`);

...
const Orientation = (props) => {
  ...
  return (
    ...
    <ul className="choice__params__el__options">
      <li 
       data-active={props.orientation === '' ? true : false}
      >
        <div
           onClick={(event) => {
             props.fun(event,"");
      ...
      <li
        data-active={props.orientation === 'landscape' ? true : false}
       >
        <div
      ...
      <li
       data-active={props.orientation=== 'portrait' ? true : false}
       >
        <div
          //  onClick={() =>
          //     {
      ...
      <li
        data-active={props.orientation=== 'square' ? true : false}
       >
        <div
          //  onClick={() => 
